...
const buttonCity = document.querySelector('.nav-info');
const spanNavigation = document.querySelector('.spanNavigation');
const buttonPrev = document.querySelector('.arrowLeft');
const buttonNext = document.querySelector('.arrowRight');
...
buttonPrev.addEventListener("click", arrowLeft);
buttonNext.addEventListener("click", arrowRight);
